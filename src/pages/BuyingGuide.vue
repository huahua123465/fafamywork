...
const items = [
  ...
  ['逐项确认交付内容', '源码、数据库初始化脚本、部署说明、安装包或构建产物，请逐项确认是否包含。第三方接口、账号与服务费用也需提前确认。'],
  ['确认报价和支持范围', '价格根据项目版本、交付内容和额外需求确认。环境配置帮助、问题处理期限、功能修改及额外收费范围，应在付款前明确。'],
  ['约定使用与验收方式', '提前约定源码的学习、二次开发和商业使用范围，是否允许转售，以及验收标准和退款处理条件。具体以双方确认的内容为准。'],
]
</script>
<template>
